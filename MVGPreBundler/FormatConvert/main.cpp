...
#else
std::string gl_ImgPathDB = "D:/Localization/Montrel/images/query/";
std::string gl_sfm_data_json = "D:/Localization/Montrel/images/query/sfm_data.json";
std::string gl_desc_feat = "D:/Localization/Montrel/images/query/";
#endif
