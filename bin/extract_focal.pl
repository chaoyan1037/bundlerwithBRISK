...
%ccd_widths = (
     ...
     "EASTMAN KODAK COMPANY KODAK DX7590 ZOOM DIGITAL CAMERA" => 5.75,
	 "EASTMAN KODAK COMPANY KODAK DX7440 ZOOM DIGITAL CAMERA" => 5.75,
	 ...
	 "NIKON CORPORATION NIKON D40X"     => 23.6,
